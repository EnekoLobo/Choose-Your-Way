...
Keycards = {
	...
	Levels = {
...

		{
			...
			Name  = "Tarjeta de identificacion",
			Color = Color(255, 0, 0)
		},

		{
			Name  = "Tarjeta de identificacion Republicana",
			Color = Color(23, 191, 240),
			customCheck = function(ply)
				-- Obtener el nombre del trabajo del jugador desde la variable personalizada
				local playerJob = ply:getDarkRPVar("job")
		
				-- Verificar si el jugador tiene un trabajo específico que tiene acceso
				return playerJob == "Iniciado Jedi" or playerJob == "Padawan Jedi" or playerJob == "Caballero Jedi" or playerJob == "Guardián Jedi" or playerJob == "Cónsul Jedi" or playerJob == "Centinela Jedi" or playerJob == "Maestro Jedi" or playerJob == "Gran Maestro Jedi" or playerJob == "Maestro Luky Sylvasta" or playerJob == "Maestra Hextar" or playerJob == "Soldado de la República: Jet" or playerJob == "Soldado de la República: Recon" or playerJob == "Soldado de la República: Espia" or playerJob == "Soldado de la República: Pesado" or playerJob == "Soldado de la República: Piloto" or playerJob == "Soldado de la República: Medica" or playerJob == "Soldado de la República" or playerJob == "Oficial de la República" or playerJob == "Gran Maestro Neverlander"
			end,
		},
