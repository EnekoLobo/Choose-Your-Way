...
function PANEL:DrawElements()
	...
	local dCheckBoxJoinMessageClient = vgui.Create( "DCheckBoxLabel", optionButtonsContainer )
	dCheckBoxJoinMessageClient:SetText( AWarn.Localization:GetTranslation( "clientjoinmessage" ) )
	dCheckBoxJoinMessageClient:DockMargin( 0, 0, 0, 4 * screenscale )
	dCheckBoxJoinMessageClient:Dock( TOP )
	dCheckBoxJoinMessageClient:SizeToContents()
	dCheckBoxJoinMessageClient.OptionString = "awarn_joinmessageclient"
	function dCheckBoxJoinMessageClient:OnChange( val )
		AWarn:SendOptionUpdate( dCheckBoxJoinMessageClient.OptionString, val )
	end
	
	local dCheckBoxJoinMessageAdmin = vgui.Create( "DCheckBoxLabel", optionButtonsContainer )
	dCheckBoxJoinMessageAdmin:SetText( AWarn.Localization:GetTranslation( "adminjoinmessage" ) )
	dCheckBoxJoinMessageAdmin:DockMargin( 0, 0, 0, 4 * screenscale )
	dCheckBoxJoinMessageAdmin:Dock( TOP )
	dCheckBoxJoinMessageAdmin:SizeToContents()
	dCheckBoxJoinMessageAdmin.OptionString = "awarn_joinmessageadmin"
	function dCheckBoxJoinMessageAdmin:OnChange( val )
		AWarn:SendOptionUpdate( dCheckBoxJoinMessageAdmin.OptionString, val )
	end
	...
	function AWarn:RefreshSettings()
		...
		dCheckBoxJoinMessageClient:SetChecked( AWarn.Options.awarn_joinmessageclient.value )
		dCheckBoxJoinMessageAdmin:SetChecked( AWarn.Options.awarn_joinmessageadmin.value )
