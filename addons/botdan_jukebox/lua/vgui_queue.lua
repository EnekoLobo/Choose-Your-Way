...
function JukeBox.VGUI.Pages.Queue:CreatePanel( parent )
	...
	parent.Header.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox.Lang:GetPhraseCaps( "#HEADING_Artist" ), "JukeBox.Font.18", w/(ScrW() > 800 and 2.5 or 2), h/2, Color( 200, 200, 200 ), 0, 1 )
		draw.SimpleText( JukeBox.Lang:GetPhraseCaps( "#HEADING_Length" ), "JukeBox.Font.18", w-(ScrW() > 800 and 135 or 30 ), h/2, Color( 200, 200, 200 ), 2, 1 )
...
function JukeBox.VGUI.Pages.Queue:CreateSongCard( parent, pos, info ) -- IT GOT A RE-DO!
	...
	card.Paint = function( self, w, h )
		...
		draw.SimpleText( JukeBox:MinWord( name, "JukeBox.Font.20", w-70-(w-(w/(ScrW() > 800 and 2.5 or 2)))-20 ), "JukeBox.Font.20", 70, h/2, Color( 255, 255, 255 ), 0, 1 )
		draw.SimpleText( JukeBox:MinWord( artist, "JukeBox.Font.20", w-10-(w/(ScrW() > 800 and 2.5 or 2))-(ScrW() > 800 and 144 or 30)-20 ), "JukeBox.Font.20", w/(ScrW() > 800 and 2.5 or 2), h/2, Color( 255, 255, 255 ), 0, 1 )
		local time =  string.FormattedTime( length )
		draw.SimpleText( time.h!=0 and Format("%02i:%02i:%02i", time.h, time.m, time.s) or Format("%02i:%02i", time.m, time.s), "JukeBox.Font.20", ScrW() > 800 and w-144 or w-30, h/2, Color( 255, 255, 255 ), 1, 1 )
		draw.RoundedBox( 0, 0, h-1, w, 1, JukeBox.Colours.Base )
	end
