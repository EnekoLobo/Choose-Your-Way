...
BRICKSCRAFTING.LUACONFIG.AdminSystem = "SAM" -- The admin mod in use, options: "Serverguard", "ULX/FAdmin/More", "xAdmin"
...
BRICKSCRAFTING.LUACONFIG.Language = "english" -- The language to be used, options: "english", "russian", "german", "polish", "french", "chinese"
