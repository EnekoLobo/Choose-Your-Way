...
function PANEL:Paint( w, h )
	...
	if( not self:IsEditing() and self:GetText() == "" ) then
		draw.SimpleText( BRICKSCRAFTING.L("vguiSearch"), "BCS_Roboto_25", 0, h/2, Color( 255, 255, 255, 20 ), 0, TEXT_ALIGN_CENTER )
	end
end
...
derma.DefineControl( "brickscrafting_search", "A simple TextEntry control", PANEL, "TextEntry" )
