...
SWEP.GiveMedicRPCash = 10					-- How much cash should a medic receive upon reviving someone? Set to 0 to disable.
...
local disableRespawnTime = 10				-- How long to disallow a player from respawning for, leave at 0 to disable
...
SWEP.respawnWaitText = "Debes esperar %d segundos a que un Medico pueda ayudarte." -- This MUST have %d in it. %d is the time left for respawn.
